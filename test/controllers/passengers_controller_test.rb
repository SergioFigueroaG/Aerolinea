...
class PassengersControllerTest < ActionController::TestCase
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post :create, passenger: { apellido: @passenger.apellido, cedula: @passenger.cedula, email: @passenger.email, nombre: @passenger.nombre, telefono: @passenger.telefono }
    end
  ...
  test "should update passenger" do
    patch :update, id: @passenger, passenger: { apellido: @passenger.apellido, cedula: @passenger.cedula, email: @passenger.email, nombre: @passenger.nombre, telefono: @passenger.telefono }
    assert_redirected_to passenger_path(assigns(:passenger))
  end
